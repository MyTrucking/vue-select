...
<template>
  <div :dir="dir" class="v-select DropdownSelector" :class="stateClasses">
    <div :class="[{'DropdownSelector--NonBillable': selectedValue[0] && selectedValue[0].isBillable === false}, 'input-group-sm']">
      <div class="DropdownSelector__Tag">
        <span class="Tag Tag--Info" title="Non Billable">NB</span>
      </div>

      <div class="form-control DropdownSelector__Input">
    ...
    <transition :name="transition">
      <div  v-if="dropdownOpen" class="vs__dropdown-wrapper">
        <ul ref="dropdownMenu" class="vs__dropdown-menu" role="listbox" @mousedown.prevent="onMousedown" @mouseup="onMouseUp">
          <li
            role="option"
          ...
          >
            <slot name="option" v-bind="normalizeOptionForSlot(option)">
              <div class="DropdownSelector__DropdownOption">
                <div v-if="option.isBillable === false" class="DropdownSelector__DropdownOptionTag"><span class="Tag Tag--Info" title="Non Billable">NB</span></div>
                <div class="DropdownSelector__DropdownOptionText">{{ getOptionLabel(option) }}</div>
              </div>
            </slot>
          </li>
